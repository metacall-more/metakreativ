...
export default function Portfolio() {
  ...
  return (
    <section className="mx-auto max-w-(--container-max) border-t border-brand-gray-300 px-5 pt-6 pb-10 md:px-8 md:pt-[30px] md:pb-[50px] lg:px-0 lg:pb-[60px]">
      ...
      <div ref={pinRef} className="portfolio-pin max-lg:h-auto!">
        <div className="portfolio-pin__stage sticky top-0 flex min-h-[calc(100vh-80px)] items-center py-10 max-lg:static max-lg:min-h-0 max-lg:py-10">
          <div className="flex w-full items-center justify-between gap-6 max-lg:flex-col max-lg:items-stretch">
