...
export default function PortfolioFilters({ activeFilter, onFilterChange }) {
  return (
    <div className="mx-auto max-w-(--container-max) px-5 md:px-8 lg:px-0">
      <div className="overflow-x-auto py-8 [-ms-overflow-style:none] [scrollbar-width:none] md:py-10 [&::-webkit-scrollbar]:hidden">
        <ul className="m-0 flex w-max list-none justify-start gap-8 md:w-full md:justify-center md:gap-12 lg:gap-16">
